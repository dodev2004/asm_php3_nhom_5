                                    ...
                                    <div class="col-md-12">
                                        <div class="row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text"
                                                    ...
                                                    id="name" name="ten_san_pham" placeholder="Nhập tên sản phẩm">
                                                @error('ten_san_pham')
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text"
                                                    ...
                                                    id="name" name="ma_san_pham" placeholder="Nhập tên sản phẩm">
                                                @error('ma_san_pham')
                                                    <p class="text-danger"> {{ $message }}</p>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number"
                                                ...
                                                id="price" name="gia_san_pham" placeholder="Nhập giá sản phẩm">
                                        </div>
                                        @error('gia_san_pham')
                                            <p class="text-danger"> {{ $message }}</p>
                                        @enderror
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="date"
                                                ...
                                                name="ngay_nhap" placeholder="Nhập số lượng">
                                        </div>
                                        @error('ngay_nhap')
                                            <p class="text-danger"> {{ $message }}</p>
                                        @enderror
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <select class="custom-select rounded-0" id="product_type" name="product_type"
                                                style="width: 100%;">
